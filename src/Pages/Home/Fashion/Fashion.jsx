...
const Fashion = () => {
  ...
  //   console.log(homeOutletShopLogo);
  ...
  const outletFashionProduct = homeOutletShopLogo.filter(
    (homeFashionProducts) => homeFashionProducts.category === "Fashion"
  );
  //   console.log(outletFashionProduct);
  const outletElectricalElectronicsProduct = homeOutletShopLogo.filter(
    (homeFashionProducts) =>
      homeFashionProducts.category === "Electrical-&-Electronics"
  );
  const outletStationeryToolsProduct = homeOutletShopLogo.filter(
    (homeFashionProducts) =>
      homeFashionProducts.category === "Stationery-&-Tools"
  );
  ...
  return (
    <div className="p-3 container">
      <div className="py-7">
        <h3 className="text-base font-semibold lg:text-3xl lg:font-bold">
          Fashion
        </h3>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {outletFashionProduct.map((fashionProduct) => (
          <BrandCard
            key={fashionProduct.id}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {outletElectricalElectronicsProduct.map((fashionProduct) => (
          <BrandCard
            key={fashionProduct.id}
            fashionProduct={fashionProduct}
          ></BrandCard>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {outletStationeryToolsProduct.map((fashionProduct) => (
          <BrandCard
            key={fashionProduct.id}
            fashionProduct={fashionProduct}
          ></BrandCard>
