...
const Sharp = () => {
    ...
    const sharpShop = items.filter(item => item.brandname === "Sharp");
    
   

    return (
        <div>
                <HeaderBrandLogo shoplogo={'https://www.brandlly.com/storage/logo/63e23e1919c1e.png'}></HeaderBrandLogo>
                <div className="relative w-full h-66">
                  <BannerParallax bannerimg={'https://www.brandlly.com/storage/banner/63fc962b7ab31.jpg'}></BannerParallax>
                  <LogoRatingVerified shoplogo={"https://www.brandlly.com/storage/logo/63e23e1919c1e.png"}></LogoRatingVerified>
                </div>
                ...
                <div className="my-3">
                <ProductTab items={sharpShop}></ProductTab>
                </div>
